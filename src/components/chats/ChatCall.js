...
const CallUI = ({ setOnCall, onCall }) => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center h-4/5 text-black ">
                <img src={Emma} className="w-24 h-24 rounded-full object-cover" alt="Emma's profile" />
                <p className=' text-3xl font-bold mt-3'>Emma</p>
                <p className=' text-base mt-1'>On Call</p>
            </div>
